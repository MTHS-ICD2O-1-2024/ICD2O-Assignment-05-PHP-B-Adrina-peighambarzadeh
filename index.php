...
<body>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content">
      ...
      <br />
      <div class="page-content-guide">Enter a non-negative number to calculate the factorial:</div>
      <div class="page-content">
        <form action="./answer.php" method="GET">
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" name="base-number" />
            <label class="mdl-textfield__label" for="base-number">Enter number here...</label>
            <span class="mdl-textfield__error">Please enter a non-negative integer!</span>
      </div>
      <br />
